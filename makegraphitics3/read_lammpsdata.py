...
class ReadLammpsData(Sim):
    ...
    def read_bonds(self, datafile):
        ...
        for i in range(self.Nbonds):
            self.read_data_line(datafile, self.bond_labels, self.bonds)
    ...
    def read_angles(self, datafile):
        ...
        for i in range(self.Nangles):
            self.read_data_line(datafile, self.angle_labels, self.angles)
    ...
    def read_dihedrals(self, datafile):
        ...
        for i in range(self.Ndihedrals):
            self.read_data_line(datafile, self.dihedral_labels, self.dihedrals)
    ...
    def read_impropers(self, datafile):
        ...
        for i in range(self.Nimpropers):
            self.read_data_line(datafile, self.improper_labels, self.impropers)
